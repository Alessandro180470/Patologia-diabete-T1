...
analisi_ematiche.append(patologia_dt1(6.4, 40, 0.12, 87, 540,'2024/09/26'))
analisi_ematiche.append(patologia_dt1(7.0, 53, 0.3, 128,560,'2023/02/28'))
analisi_ematiche.append(patologia_dt1(7.1, 55, 0.5, 165,525,'2022/10/21'))
analisi_ematiche.append(patologia_dt1(7.4, 53, 0.66, 160,455,'2023/09/30'))
analisi_ematiche.append(patologia_dt1(6.4, 48, 0.66, 185,321,'2024/09/30'))
analisi_ematiche.append(patologia_dt1(6.9, 49, 0.1, 195,385,'2017/11/29'))
analisi_ematiche.append(patologia_dt1(7.0, 49, 0.25, 240,320,'2021/10/23'))
